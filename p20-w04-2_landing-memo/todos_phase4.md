...
1.  **Create Motion Wrapper Structure:**
...
2.  **Implement `HeroMotionWrapper.tsx`:**
...
3.  **Implement `CardMotionWrapper.tsx`:**
...
6.  **Update `package.json` and install Framer Motion:**
