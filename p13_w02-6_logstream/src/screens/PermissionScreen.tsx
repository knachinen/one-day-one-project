...
export const PermissionScreen = () => {
    ...
    const checkPermission = async () => {
        try {
            const result = await PermissionsAndroid.check('android.permission.READ_LOGS' as any);
            if (result) {
...
const styles = StyleSheet.create({
    ...
    code: { backgroundColor: '#eee', padding: 10, marginBottom: 20, fontFamily: 'monospace' }
});
