  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#E8F0FF] via-[#F3E8FF] to-[#EBF9EE] overflow-hidden font-sans">
      ...
      <div className="z-10 text-center px-4">
        <h1 className="text-[56px] font-extrabold text-[#1A1A1A] leading-[1.2] tracking-[-0.02em] mb-6">
          생각이 떠오르는 순간, <br/>
          <span className="text-[#7C4DFF]">바로 메모</span>
        </h1>
        <p className="text-[#666666] text-lg md:text-xl font-medium mb-10 leading-[1.5] max-w-2xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex flex-wrap justify-center gap-4">
            <button className="group flex items-center gap-2 px-10 py-4 bg-[#7C4DFF] text-white font-extrabold rounded-full shadow-[0_15px_30px_rgba(124,77,255,0.4)] hover:scale-105 hover:shadow-[0_20px_40px_rgba(124,77,255,0.5)] transition-all duration-300">
              무료로 시작하기
            ...
            <button className="px-10 py-4 bg-white text-gray-700 font-extrabold rounded-full border border-gray-100 shadow-sm hover:bg-gray-50 transition-colors">
              앱 다운로드
            </button>
          </div>

          <div className="flex flex-wrap justify-center gap-6 text-sm font-extrabold text-[#4CAF50]">
      ...
      {/* Floating Memo Cards */}
      <MemoCard className="absolute hidden lg:block top-[12%] left-[8%] w-60 bg-white/90 backdrop-blur-sm p-6 rounded-[24px] shadow-[0_20px_40px_rgba(0,0,0,0.06)] -rotate-6 transition-transform hover:rotate-0 hover:scale-105 duration-500">
        <p className="text-[10px] font-bold text-[#666666] mb-3 uppercase tracking-tighter">장보기 리스트</p>
        <div className="space-y-3 mb-4">
          ...
          <div className="flex items-center gap-2"><div className="w-4 h-4 border-2 border-gray-200 rounded"></div><span className="text-sm font-semibold text-[#666666]">청경채</span></div>
          <div className="flex items-center gap-2"><div className="w-4 h-4 border-2 border-gray-200 rounded"></div><span className="text-sm font-semibold text-[#666666]">사과 3개</span></div>
        </div>
        <span className="inline-block px-3 py-1 bg-[#F0EBFF] text-[#7C4DFF] text-[10px] font-black rounded-lg">#영감</span>
      </MemoCard>

      <MemoCard className="absolute hidden lg:block top-[15%] right-[10%] w-52 bg-white/90 backdrop-blur-sm p-4 rounded-[20px] shadow-[0_20px_40px_rgba(0,0,0,0.08)] rotate-6 transition-transform hover:rotate-0 hover:scale-105 duration-500">
        <div className="aspect-square bg-gray-50 rounded-xl mb-3 flex items-center justify-center border border-gray-100 relative">
          ...
          <div className="absolute bottom-2 right-2 p-1.5 bg-white shadow-sm rounded-md border border-gray-100"><svg className="w-3 h-3 text-[#666666]" fill="currentColor" viewBox="0 0 20 20"><path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path></svg></div>
        </div>
        <h4 className="text-sm font-bold text-gray-800">새 로고 아이디어</h4>
        <p className="text-[10px] text-[#666666]">미니멀한 스타일로...</p>
      </MemoCard>

      <MemoCard className="absolute hidden lg:block bottom-[18%] left-[12%] w-64 bg-white/90 backdrop-blur-sm p-5 rounded-[20px] shadow-[0_20px_40px_rgba(0,0,0,0.05)] rotate-2 transition-transform hover:rotate-0 hover:scale-105 duration-500">
      ...
      <MemoCard className="absolute hidden lg:block bottom-[15%] right-[12%] w-64 bg-white/90 backdrop-blur-sm p-6 rounded-[20px] shadow-[0_20px_40px_rgba(0,0,0,0.05)] -rotate-3 transition-transform hover:rotate-0 hover:scale-105 duration-500">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-[#666666]">오후 2:00 - 3:00</p>
          </div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50">
        <span className="text-[10px] font-black tracking-[0.2em] uppercase text-[#666666]">SCROLL FOR MORE</span>
