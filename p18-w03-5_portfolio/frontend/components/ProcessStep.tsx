  ...
  return (
    <div className="relative flex items-start gap-4">
      <div className="flex flex-col items-center">
        <div className="flex items-center justify-center w-10 h-10 bg-primary text-white rounded-full text-lg font-black z-10">
          {step}
        </div>
        {!isLast && (
          <motion.div
            className="w-0.5 h-full bg-primary absolute top-10 left-1/2 -translate-x-1/2"
            initial={{ height: 0 }}
